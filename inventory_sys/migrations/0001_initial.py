    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('units', models.CharField(choices=[('pcs', 'Pieces'), ('kg', 'Kilograms'), ('l', 'Liters'), ('m', 'Meters')], default='pcs', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='orders', to='inventory_sys.customer')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='orders', to='inventory_sys.product')),
                ('batch_sku', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='orders', to='inventory_sys.productbatch')),
            ],
            options={
                'ordering': ['-order_date'],
            },
